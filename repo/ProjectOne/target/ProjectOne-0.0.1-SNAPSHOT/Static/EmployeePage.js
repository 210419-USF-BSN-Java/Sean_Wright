 ...
 * 
 */
document.getElementById('profile').onclick = ViewInformation;
document.getElementById('viewPending').onclick = AddREimbursement;// () calls fucnction without event
document.getElementById('viewResolved').onclick = udateInformation;
document.getElementById('createForm').onclick = ViewResolvedREquests;
document.getElementById('submitForm').onclick= ViewPending;
...
async function AddReimbursement(){
    ...
    if(response.status >= 200 && response.status < 300){
        ...
        document.getElementById('body').innerHTML = `<p> An error occured </p>`
    }
}
